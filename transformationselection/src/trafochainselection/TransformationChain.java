 ...
 *   <li>{@link trafochainselection.TransformationChain#getInputModel <em>Input Model</em>}</li>
...
public interface TransformationChain extends EObject {
    ...
    * @see #setInputModel(String)
    * @see trafochainselection.TrafochainselectionPackage#getTransformationChain_InputModel()
    * @model required="true"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link trafochainselection.TransformationChain#getInputModel <em>Input Model</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   void setInputModel(String value);
   ...
   /**
    * Unsets the value of the '{@link trafochainselection.TransformationChain#getOutputMM <em>Output MM</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see #isSetOutputMM()
    * @see #getOutputMM()
   ...
   /**
    * Returns whether the value of the '{@link trafochainselection.TransformationChain#getOutputMM <em>Output MM</em>}' reference is set.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return whether the value of the '<em>Output MM</em>' reference is set.
    * @see #unsetOutputMM()
    * @see #getOutputMM()
    * @see #setOutputMM(Metamodel)
    * @generated
    */
   boolean isSetOutputMM();
