 ...
 *   <li>{@link trafochainselection.Transformation#getMetrics <em>Metrics</em>}</li>
...
public interface Transformation extends EObject {
    ...
    * @see #setMetrics(Map)
    * @see trafochainselection.TrafochainselectionPackage#getTransformation_Metrics()
   ...
   /**
    * Sets the value of the '{@link trafochainselection.Transformation#getMetrics <em>Metrics</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   void setMetrics(Map<String, Double> value);
